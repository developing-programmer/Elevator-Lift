...
async function statusCheck(req, res) {
  try {
    ...
    const queryStatus = `SELECT elev."elevatorId", elev."currentFloor", elev."statusId", stat."status", elev."direction", elev."targetFloor", elev."updatedAt", elev."active", elev."currentAPIReq", elev."queue" FROM "ElevatorState" elev 
...
async function requestElevator(req, res) {
  try {
    ...
    const queryStatus = `SELECT elev."elevatorId", elev."currentFloor", elev."statusId", stat."status", elev."direction", elev."targetFloor", elev."updatedAt", elev."active", elev."currentAPIReq", elev."queue" FROM "ElevatorState" elev INNER JOIN "Status" stat ON elev."statusId" = stat."statusId" WHERE "elevatorId"=${elevatorId};`
